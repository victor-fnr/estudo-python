...
Este repositório é dedicado ao meu aprendizado de Python, focado em construir uma base sólida para análise de dados. Aqui documento a evolução da minha lógica de programação através de cursos e exercícios práticos.
...
- [x] Lógica de programação e comandos básicos.
...
Conteúdo prático baseado nas trilhas de aprendizado do **Téo Calvo (@teomewhy)**, focadas na democratização do conhecimento em dados.
